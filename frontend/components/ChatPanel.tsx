...
import type { ConnectionStatus, Message, Provider } from "../types";
...
export function ChatPanel({ messages, status, provider, isSpeaking, onSend }: Props) {
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div ref={listRef} className="flex-1 space-y-3 overflow-y-auto px-4 py-4 scrollbar-none">
        {messages.length === 0 && (
