      ...
      <main className="mx-auto w-full max-w-4xl space-y-6 px-4 py-8">
        <section className="rounded-2xl border border-border bg-surface p-5 shadow-sm">
          ...
          <div className="mt-5 grid gap-5">
            ...
            <CommandBlock
              label="7) Start the web dashboard (new terminal)"
              command={commands.ui}
            />
          </div>
        </section>
          ...
          <div className="rounded-2xl border border-border bg-surface p-5 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              <CommandBlock
                ...
                command={"docker build -t jarvis-agi ."}
              />
              <CommandBlock
                label="Run the API on port 8000"
                command={"docker run --rm -p 8000:8000 jarvis-agi"}
              />
            </div>

            <p className="mt-3 text-xs text-muted">
              If you host the UI remotely, set{" "}
              <code className="rounded border border-border bg-surface-muted px-1 py-0.5 text-[11px]">
                VITE_API_ORIGIN
              </code>{" "}
              to your API origin (no trailing slash).
            </p>
          </div>
        </section>
      </main>
